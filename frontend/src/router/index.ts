...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'student/class', component: () => import('@/views/student/StudentClassView.vue') },
      ...
      { path: 'teacher/classes', component: () => import('@/views/teacher/TeacherHomeroomClassesView.vue') },
      ...
      { path: 'admin/batch-tasks', component: () => import('@/views/admin/BatchTasksView.vue') },
      { path: 'admin/data-archive', component: () => import('@/views/admin/DataArchiveView.vue') },
